...
- (id)initWithNamespace:(NSString *)ns
{
    if ((self = [super init]))
    {
        NSString *fullNamespace = [@"me.vvebo.SDWebImageCache." stringByAppendingString:ns];

        // Create IO serial queue
        _ioQueue = dispatch_queue_create("me.vvebo.SDWebImageCache", DISPATCH_QUEUE_SERIAL);
...
- (void)clearDisk:(void (^)(void))complet
{
	dispatch_group_t group = dispatch_group_create();
	dispatch_group_async(group, self.ioQueue, ^{
